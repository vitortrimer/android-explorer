...
import trimer.vitor.fileexplorer.Fragments.CardFragment;
import trimer.vitor.fileexplorer.Fragments.HomeFragment;
import trimer.vitor.fileexplorer.Fragments.InternalFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_card:
                ...
                break;
            case R.id.nav_about:
                Toast.makeText(this, "Made by Vitor Trimer", Toast.LENGTH_SHORT).show();
                break;
        }
