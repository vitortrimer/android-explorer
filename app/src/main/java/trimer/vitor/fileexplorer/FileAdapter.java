...
public class FileAdapter extends RecyclerView.Adapter<FileViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FileViewHolder holder, int position) {
        ...
        if(file.get(position).getName().toLowerCase().endsWith(".jpeg") || file.get(position).getName().toLowerCase().endsWith(".jpg") || file.get(position).getName().toLowerCase().endsWith(".png") || file.get(position).getName().toLowerCase().endsWith(".gif")) {
